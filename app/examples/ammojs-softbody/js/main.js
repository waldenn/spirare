...
function createObjects() {
	...
	pos.set( 0, - 0.5, 0 );
	quat.set( 0, 0, 0, 1 );
	var ground = createParalellepiped( 40, 1, 40, 0, pos, quat, new THREE.MeshNormalMaterial( { color: 0xFFFFFF } ) );
	...
	textureLoader.load( "textures/grid.png", function( texture ) {
		...
		ground.material.needsUpdate = false;
	} );
	...
	var obstacle = createParalellepiped( 10, 1, 4, 0, pos, quat, new THREE.MeshNormalMaterial( { color: 0x606060 } ) );
...
function createSoftVolume( bufferGeom, mass, pressure ) {
	...
	var volume = new THREE.Mesh( bufferGeom, new THREE.MeshNormalMaterial( { color: 0xFFFFFF } ) );
